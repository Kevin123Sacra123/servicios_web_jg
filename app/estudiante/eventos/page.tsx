            ...
            <div className="">
                <div className="max-w-7xl mx-auto p-5">
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        {eventos.map(event => (
                        <article key={event.id_evento} className="w-[400px] bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm hover:shadow-lg transition">
                            ...
                            <div className="p-5">
                                ...
                                <h2 className="mt-5 text-3xl font-bold text-slate-900">{event.nombre}</h2>
                                <div className="mt-5 space-y-3">
                                    ...
                                    <div className="flex items-center gap-3 text-slate-600">
                                        <CiCalendar />
                                        <span>{event.fecha}, {event.hora_inicio} - {event.hora_fin}</span>
                                    </div>
                                    <div className="flex items-center gap-3 text-slate-600">
                                        <CiLocationOn />
